...
export const BentoGridItem = ({
  ...
  return (
    <div
      className={cn(
        `row-span-1 relative hover:scale-105 overflow-hidden rounded-3xl border border-white/[0.1] group/bento hover:shadow-xl transition duration-300 shadow-input dark:shadow-none justify-between flex flex-col space-y-4 lg:col-span-3 md:col-span-6 md:row-span-4 `,
        className
      )}
      style={{
    ...
    >
      <div className={`${id === 6 && "flex justify-center "}  h-full`}>
        ...
        <div
          className={cn(
            titleClassName,
            "group-hover/bento:scale-90  transition duration-300 relative md:h-full min-h-40 flex flex-col px-5 p-5 lg:p-10"
          )}
        >
